...
// This is an interesting idea. In the case of time-series variables, a
// correlation-based comparison seems natural. This can be generalized to
// calculate other metrics that describe the similarity between objects in
// other contexts.
export const buildCorrelationDictionary = async (symbols, directory, similarityFunction = correlation) => {
  ...
  for (let i = 0; i < symbols.length; i++) {
    ...
    for (let j = i + 1; j < symbols.length; j++) {
      ...
      const correlationCalc = similarityFunction(seriesX, seriesY);
